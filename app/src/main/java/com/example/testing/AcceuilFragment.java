...
public class AcceuilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_list_cat=v.findViewById(R.id.tv_voir_catR);
        txt_list_cat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getActivity(), ListCategorieCRestauActivity.class);
                startActivity(i);
