...
import com.example.testing.CategorieRestau.listMenuRestauByCat;
...
public class CatMenuRAdapter extends ArrayAdapter {
    List<Categorie> CatList= new ArrayList<>();
    Context context;

    public CatMenuRAdapter(@NonNull Context context, int resource, @NonNull List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = inflater.inflate(R.layout.catmenugriditemr, null);
        TextView textView = (TextView) v.findViewById(R.id.titreCatItemr);
        ImageView imageView = (ImageView) v.findViewById(R.id.imageCatItemr);
        textView.setText(CatList.get(position).getNomCat());

        v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getContext(), listMenuRestauByCat.class);
